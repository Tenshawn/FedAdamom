...
def args_parser():
    ...
    parser.add_argument('--beta_', type=float, default=0, help='')   
    parser.add_argument('--beta_0', type=float, default=0, help='')   
    ...
    parser.add_argument('--eps', type=float, default=1e-03, help='eps')
